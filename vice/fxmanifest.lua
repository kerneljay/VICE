...
server_scripts{ 
  ...
  -- "modules/misc/sv_playerdealership.lua",
  --
  "cfg/discordroles.lua",
  "pma/server/**/*.lua",
	"pma/server/**/*.js",
 -- "modules/misc/sv_vicepoints.lua",
}
...
client_scripts  {
  ...
  "client/menus/cl_adminmenu.lua",
   "client/menus/cl_eventsmenu.lua",
    "client/menus/overwatch.lua",
