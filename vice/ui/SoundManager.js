const audio = [
  {name:"stop", file:"stop.ogg", volume: 0.0},
  ...
  {name:"radiooff", file:"radioon.ogg", volume: 0.1},
  {name:"radioon", file:"radiooff.ogg", volume: 0.1},
  ...
  {name:"iphone_dodoDO", file:"iphone_dodoDO.ogg", volume: 0.4},
  ...
  {name:"whoosh", file:"whoosh.ogg", volume: 0.3},
  {name:"thump", file:"thump.ogg", volume: 0.3},
  ...
  {name:"testFailedGoodbye", file:"testFailedGoodbye.ogg", volume: 0.50},
  ...
  {name:"purge", file:"purge.ogg", volume: 0.8},
  ...
  {name:"chess_capture", file:"chess_capture.ogg", volume: 1.0},
  {name:"chess_move", file:"chess_move.ogg", volume: 1.0},
  {name:"chess_notify", file:"chess_notify.ogg", volume: 1.0},
  {name:"gangping1", file:"gangping1.ogg", volume: 1.0},
  {name:"gangping2", file:"gangping2.ogg", volume: 1.0},
  {name:"gangping3", file:"gangping3.ogg", volume: 1.0},
  {name:"gangping4", file:"gangping4.ogg", volume: 1.0},
  {name:"gangping5", file:"gangping5.ogg", volume: 1.0},
  {name:"gangping6", file:"gangping6.ogg", volume: 1.0},
  {name:"gangping7", file:"gangping7.ogg", volume: 1.0},
  {name:"gangping8", file:"gangping8.ogg", volume: 1.0},
]
