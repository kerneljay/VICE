...
cfg.tvScriptRenderTargetTextures = {
    [`prop_monitor_01b`] = "script_rt_evotv2",
    [`prop_tv_flat_01`] = "script_rt_evotv5",
    [`sm_prop_smug_tv_flat_01`] = "script_rt_evotv8",
    [`prop_tv_flat_02b`] = "script_rt_evotv6",
    [`prop_tv_flat_03b`] = "script_rt_evotv7",
    [`apa_mp_h_str_avunits_04`] = "script_rt_evotv1",
    [`v_ilev_mm_screen2`] = "script_rt_evotv9",
    [`prop_tv_02`] = "script_rt_evotv3",
    [`prop_tv_03`] = "script_rt_evotv4"
}
