...
cfg.weapons = {
	...
	[`WEAPON_BLACKICEMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_blackicemosin`},
	[`WEAPON_BLOODMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_bloodmosin`},
	[`WEAPON_GREENMANORMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_greenmanormosin`},
	[`WEAPON_MANORMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_manormosin`},
	[`WEAPON_NIGHTMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_nightmosin`},
	[`WEAPON_PINKMANORMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_pinkmanormosin`},
	[`WEAPON_REDLVMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_redlvmosin`},
	[`WEAPON_TOMMYMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_tommymosin`},
	[`WEAPON_AYRESSYMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_ayressymosin`},

	--?Rifles
	[`WEAPON_GOLDAK`] = {bone = 24818, offset = vector3(-0.12, -0.15, 0.0), rotation = vector3(3.0, -3.0, 5.0), model = `w_ar_goldak`},
	[`WEAPON_CNDYRIFLE`] = {bone = 24818, offset = vector3(-0.12, -0.15, 0.0), rotation = vector3(3.0, -3.0, 5.0), model = `w_ar_cndyrifle`},
	[`WEAPON_ICEDRAKE`] = {bone = 24818, offset = vector3(-0.12, -0.15, 0.0), rotation = vector3(3.0, -3.0, 5.0), model = `w_ar_icedrake`},
	[`WEAPON_DARKMATTERVANDAL`] = {bone = 24818, offset = vector3(-0.12, -0.15, 0.0), rotation = vector3(3.0, -3.0, 5.0), model = `w_ar_darkmattervandal`},

	--?SMGs
	[`WEAPON_DIAMONDMP5`] = {bone = 24818, offset = vector3(-0.12, -0.15, 0.0), rotation = vector3(3.0, -3.0, 5.0), model = `w_sb_diamondmp5`},
	[`WEAPON_UMPV2NEONOIR`] = {bone = 24818, offset = vector3(-0.12, -0.15, 0.0), rotation = vector3(3.0, -3.0, 5.0), model = `w_sb_umpv2neonoir`},
	[`WEAPON_AK47GOKU`] = {bone = 24818, offset = vector3(-0.12, -0.15, 0.0), rotation = vector3(3.0, -3.0, 5.0), model = `w_sb_ak47goku`},
}
