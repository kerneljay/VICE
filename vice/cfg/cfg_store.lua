...
cfg.items = {
    ...
    ["melee_import"] = {
        name = "Melee Import",
        description = "To use this item open a Weapon Ticket in the VICE Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["pistol_import"] = {
    ...
    ["lock_slot"] = {
        name = "Lock Slot",
        description = "To use this item open a Ticket in the VICE Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["import_slot"] = {
        name = "Import Slot",
        description = "To use this item as an import slot open a Ticket in the VICE Support tickets Discord.",
        manuallyRedeemable = true,
        canTransfer = true,
        args = "import_slot"
    },
...
local customCars = {
    ...
    ["Coupes"] = {
        ...
        ["m6f13"] = "BMW M6 F13",
      --  ["ap2"] = "Honda s2000", -- Not In
      --  ["carlton"] = "Lotus Carlton 1989", -- Not in
    --    ["mx5m"] = "Mazda MX5 Drift", -- Not in
       -- ["fc3s"] = "Mazda RX7 FC3S", -- Not in
        ["rmodamgc63"] = "Mercedes AMG C63S Coupe Widebody",
       -- ["c63sc"] = "Mercedes AMG C63s Coupe", -- Not in
        ["amggtsmansory"] = "Mercedes AMG GT S Mansory",
     --   ["amggtr"] = "Mercedes AMG GTR 2017", -- Not in
      --  ["wraithb"] = "Rolls Royce Wraith Black Badge" -- Not in
    },
    ["Sedans"] = {
...
local function buildCustomCarArgument(number)
    return {
        ...
        description = "Select the custom car to be added to your garage. Leave empty to receive an import slot instead.",
