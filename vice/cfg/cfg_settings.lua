...
cfg.presets = {
        ...
        presets = {
            {
                ...
                values = {
                    ...
                    ["misc.coronas.underwaterFadeDist"] = 0.0,
    ...
    },
    {
        ...
        presets = {
            {
                name = "Disable Low Priority Props",
                description = "Removes small ambient world objects such as signs, bins, crates, rubbish, etc",
                values = {
                    "bkr_meet_room_cash2",
                    "prop_ld_binbag_01",
                    "prop_bin_01a",
                    ...
                    "prop_rub_binbag_sd_04",
                    "prop_rub_binbag_sd_05",
                    "prop_rub_binbag_sd_06",
                    "prop_rub_binbag_sd_07",
                    "prop_rub_binbag_sd_08",
                    "prop_rub_binbag_sd_09",
                    "prop_rub_binbag_sd_10",
                    "prop_rub_binbag_sd_11",
                    "prop_rub_binbag_sd_12",
                    "prop_rub_binbag_sd_13",
                    "prop_rub_binbag_sd_14",
                    "prop_rub_binbag_sd_15",
                    "prop_rub_binbag_sd_16",
                    "prop_rub_binbag_sd_17",
                    "prop_rub_binbag_sd_18",
                    "prop_rub_binbag_sd_19",
                    "prop_rub_binbag_sd_20",
                    "prop_rub_binbag_sd_21",
                        -- Add other props you want to remove
                }
            }
        },
        default = {
