...
cfg.garages = {
    ...
    --     name = "Evn's Customs",
    --     type = "automobile",
	-- 	camera = {position = vector3(109.98567962646,264.61123657227,112.33306121826)},
	-- 	driveOut = {position = vector3(111.1051864624,266.45721435547,109.4659576416), heading = 326.0},
	-- 	driveIn = {position = vector3(115.74765777588,278.69235229492,110.05861663818), heading = 123.0},
	-- 	outside = {position = vector3(115.74765777588,278.69235229492,110.05861663818)},
	-- 	inside = {position = vector3(111.1051864624,266.45721435547,109.4659576416)}
	-- },
    -- {
    --     name = "Soap's Workshop",
    --     type = "automobile",
	-- 	camera = {position = vector3(478.9296875,-1316.2744140625,29.203680038452)},
	-- 	driveOut = {position = vector3(480.533203125,-1317.564453125,29.203048706055), heading = 297.0},
	-- 	driveIn = {position = vector3(486.85388183594,-1314.4730224609,29.23517036438), heading = 113.0},
	-- 	outside = {position = vector3(486.85388183594,-1314.4730224609,29.23517036438)},
	-- 	inside = {position = vector3(480.533203125,-1317.564453125,29.203048706055)}
	-- },
    -- {
    --     name = "Soap's bubble bath",
    --     type = "automobile",
...
local advancedVehicleAlarms = {
    {name = "None", mod = 30, price = 0},
    {name = "Advanced Vehicle Alarm", mod = 31, price = 2000000}
}
    ...
    categories = {
        ...
        },
        {
            ...
            categories = {
                ...
                {
                    type = "staticList",
                    name = "Advanced Vehicle Alarm",
                    description = "Notification upon your vehicle being lockpicked.",
                    saveKey = "security_alarm",
                    saveValue = "mod",
                    items = advancedVehicleAlarms,
                    disabled = false,
                },
                {
                    type = "staticList",
