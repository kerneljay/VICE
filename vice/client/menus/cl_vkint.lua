local a = {
    ...
    [5] = {id = 5, position = vector3(-747.962890625,5807.5263671875,17.620700836182), name = "Lodges", destination = {6}},
    [6] = {id = 6, position = vector3(-2171.8022460938,5141.736328125,2.808837890625), name = "Vip island", destination = {5,133}},
    [7] = {
        id = 7,
        position = vector3(-2333.3315429688,266.18127441406,169.60194396973),
        name = "Kortz Center",
        destination = {5}
    },
    [59] = {
    ...
    [95] = {
        id = 95,
        position = vector3(-679.56378173828, 5833.9790039062, 17.331336975098),
        name = "FFA Maps",
        destination = {96, 100, 99}
    },
    -- [96] = {
    --     id = 96,
    --     position = vector3(-3739.4289550781, -2982.0285644531, 542.92022705078),
    --     name = "Lego Arena",
    --     destination = {95}
    -- },
    [99] = {
        id = 99,
        position = vector3(3221.8627929688, -131.3642578125, 1387.3713378906),
        name = "Sky World",
        destination = {95}
    },
    [100] = {
        id = 100,
        position = vector3(-52.361022949219, -1143.8450927734, -1.4446125030518),
    ...
    [115] = {
        id = 115,
        position = vector3(-51.74275970459,-1289.9926757812,30.905096054077),
        name = "Boxing Gym",
        destination = {114}
    },
    [116] = {
    ...
    [132] = {
       ...
       [133] = {
        id = 133,
        position = vector3(158.8147277832,-1067.9652099609,29.192373275757),
        name = "JD",
        destination = {6}
    }
}

RMenu.Add("vkint","mainmenu",RageUI.CreateMenu("~b~T~w~eleporter", "Main Menu", VICE.getRageUIMenuWidth(), VICE.getRageUIMenuHeight()))
local b = nil
local function c(d)
    if VICE.getPlayerCombatTimer() > 0 then
        VICE.notify("You can not teleport whilst you have a combat timer.")
        return
    end
...
AddEventHandler('playerSpawned', function(spawn)
    for f, d in pairs(a) do
        tVICE.addMarker(d.position.x, d.position.y, d.position.z - 1, 1.0, 1.0, 1.0, 255, 255, 255, 170, 200, 27)
        VICE.createArea("vkint_" .. d.id,d.position,2.0,10.0,l,m,function()end,d)
    end
end)