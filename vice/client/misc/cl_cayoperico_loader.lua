...
Citizen.CreateThread(function()
    VICE.createArea("cayo_island",vector3(5218.9399414062,-5393.2563476562,67.318588256836),2142.0,1400.0,function()
        TogglePerico()
    end,function()
        TogglePerico()
    end,
...
Citizen.CreateThread(function()
    while true do 
        local i=#(GetEntityCoords(PlayerPedId())-vector3(4858.0,-5171.0,2.0))<2200.0;
        if g~=i then 
            g=i;
            h=i;
            SetToggleMinimapHeistIsland(g)
        end;
        Wait(5000)
    end 
end)
