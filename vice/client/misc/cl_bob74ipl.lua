...
local GetInteriorAtCoordsWithType = GetInteriorAtCoordsWithType
local IsValidInterior = IsValidInterior
local ActivateInteriorEntitySet = ActivateInteriorEntitySet
local DeactivateInteriorEntitySet = DeactivateInteriorEntitySet
local RefreshInterior = RefreshInterior
...
Citizen.CreateThread(function()
    for _, j in ipairs(i) do
        ...
        if IsValidInterior(k) then
            if j.request then
                for _, l in ipairs(j.request) do
                    ActivateInteriorEntitySet(k, l)
                end
            end
            if j.remove then
                for _, l in ipairs(j.remove) do
