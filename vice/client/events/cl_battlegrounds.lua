...
--     end
-- )
-- VICE.registerEventMenuItem("Battle Royal","Vice Battlegrounds",function()
...
--                             minplayers = 2
--                             VICE.notify("~g~The Server players is less than 5, setting minimum players to 2.")
--                             return
--                         end
--                         if tonumber(P) < 5 then
--                             VICE.notify("~r~Minimum players can not be less than 5.")
--                             return
--                         end 
...
--                             VICE.notify("~r~Maximum players can not be more than "..defaultmaxplayers..".")
--                             return
--                         end
...
--             if k then
--                 e = c.location
--                 TriggerServerEvent("VICE:startEvent","Battle Royal","Vice Battlegrounds",minplayers,maxplayers,{locationIndex = c.location, name = d[c.location]})
--             end
--         end)
--     end
-- end)
...
--         end
--         DrawAdvancedText(0.591, 0.042, 0.005, 0.0028, 0.993, "VICE BATTLEGROUNDS", 255, 255, 255, 255, 6, 0)
--     end
-- end
...
--                     VICE.setPlayerCanOpenLeaderboard(true)
...
-- VICE.createThreadOnTick(func_handleClicks)
...
-- RegisterNetEvent(
--     "VICE:syncLootboxesTable",
--     function(t, u)
--         g.data.lootBoxes = table.copy(b.lootBoxes[u])
--         g.data.armourPlates = table.copy(b.armourPlates[u])
--         VICE.loadModel("prop_box_ammo03a")
--         for v, w in pairs(g.data.lootBoxes) do
--             if #(w.coords - g.gas.coords) < g.gas.radius / 2 then
--                 g.data.lootBoxes[v].areaId = "VICEbr_lootbox_" .. v
--                 tVICE.setNamedBlip("VICEbr_lootbox_" .. v, w.coords.x, w.coords.y, w.coords.z, 478, 1, "Lootbox", 0.5)
--                 local x = function(y)
...
--                 local A = function()
--                 end
--                 VICE.createArea("VICEbr_lootbox_" .. v, w.coords, 200.0, 6, x, z, A, {box = v})
--             end
--         end
--         SetModelAsNoLongerNeeded("prop_box_ammo03a")
--         VICE.loadModel("prop_armour_pickup")
--         for v, w in pairs(g.data.armourPlates) do
--             if #(w.coords - g.gas.coords) < g.gas.radius / 2 then
--                 tVICE.setNamedBlip("VICEbr_armour_" .. v, w.coords.x, w.coords.y, w.coords.z, 175, 1, "Lootbox", 0.5)
--                 local B = function(C)
...
--                             VICE.DrawText3D(vector3(F.x, F.y, F.z - 0.5), "Press [E] to pickup armour.", 0.2)
--                             if IsControlJustPressed(0, 51) then
--                                 TriggerServerEvent("VICE:removeArmourPlate", C.plateId)
--                                 SetPedComponentVariation(PlayerPedId(), 9, 15, 3, 0)
--                             end
--                         end
--                     end
--                 end
--                 VICE.createArea("VICEbr_armour_" .. v, w.coords, 200.0, 6, B, D, E, {plateId = v})
--                 g.data.armourPlates[v].areaId = "VICEbr_armour_" .. v
--             end
--         end
...
--     "VICE:removeLootBox",
--     function(G)
--         tVICE.removeArea("VICEbr_lootbox_" .. G)
--         tVICE.removeNamedBlip("VICEbr_lootbox_" .. G)
...
-- )
-- RegisterNetEvent(
--     "VICE:removeArmourPlateCl",
--     function(H)
--         tVICE.removeArea("VICEbr_armour_" .. H)
--         tVICE.removeNamedBlip("VICEbr_armour_" .. H)
...
-- )
-- RegisterNetEvent(
--     "VICE:startBattlegrounds",
--     function(I)
--         e = I
--         VICE.startGas(b.locations[e].gas.initalRadius, b.locations[e].gas.centre)
...
--         VICE.stopEventSequence(true)
--         tVICE.GiveWeaponsToPlayer({["GADGET_PARACHUTE"] = {2}})
--         SetEntityCoords(PlayerPedId(), b.locations[e].planeStart)
--         VICE.loadModel("cargoplane")
--         for o, p in pairs(GetActivePlayers()) do
--             if p ~= PlayerId() then
...
--             end
--         end
--         local J = VICE.spawnVehicle("cargoplane", b.locations[e].planeStart, b.locations[e].planeHeading, false, false, true)
...
--         inGUIVICE = true
--         setCursor(1)
--         TriggerEvent("VICE:PlaySound", "questcomplete")
--     end
-- )
-- VICE.registerEventCleanupHandler(
--     "Vice Battlegrounds",
--     function()
--         currentEvent.isActive = false
--         VICE.setPlayerCanOpenLeaderboard(false)
--         for v, w in pairs(g.data.lootBoxes) do
--             tVICE.removeArea(w.areaId)
--             tVICE.removeNamedBlip(w.areaId)
...
-- end
-- function VICE.changeGasRadius(M)
--     SendNUIMessage({transactionType = "br-gas"})
--     g.gas.timeUntilNext = {minutes = 2, seconds = 0}
--     VICE.announceMpBigMsg("~r~GAS MOVING", "The gas is closing in!", 5000)
--     Wait(4000)
--     Citizen.CreateThread(
--         function()
...
--                         VICE.changeGasRadius(g.gas.radius - 400)
--                     else
...
--         end
--         VICE.updateScoreboard(p, 5, g.players[p].kills)
--         Q()
--     end
-- )
-- RegisterNetEvent(
--     "VICE:removePlayerFromBR",
--     function(V)
--         if g.players[V] then
...
--             end
--         end
--         VICE.removePlayerFromLeaderboard(V)
--     end
-- )
-- Citizen.CreateThread(function()
--     while true do
--         if g.gas.isActive and g.player.hasJumped and not IsPedInParachuteFreeFall(PlayerPedId()) and GetPedParachuteState(PlayerPedId()) <= 2 and currentEvent.isActive and not VICE.isSpectatingEvent() then
--             if #(VICE.getPlayerCoords().xy - g.gas.coords.xy) > g.gas.radius / 2.0 then
...
--     end
-- end)
-- RegisterNetEvent("VICE:setMaxPlayers", function(W)
--     defaultmaxplayers = W
-- end)