...
exports.runcmd = (fivemexports, client, message, params) => {
    let embed = {
        "title": "VICE His Majesty's Prison Service",
        ...
        "fields": [
            ...
            },
            {
                ...
                "value": "To join the Prison Service, you need to create an account on vicestudios.net and use the [application](https://soon). Make sure to be in the VICE HMPS Official [Discord](https://discord.gg/FSuyApRjKY) server.",
            },
            {
    ...
    message.channel.send("||                                                  https://discord.gg/FSuyApRjKY                                     ||");
};
