...
exports.runcmd = (fivemexports, client, message, params) => {
    let embed = {
        "title": "VICE National Health Service",
        ...
        "fields": [
            {
                ...
                "value": "To become part of the NHS, you must have an account on vicestudios.net and use this [link](https://soon). Make sure to fill out everything on the form correctly; failure to do so will result in denial of the application. Also, make sure to be in the VICE NHS [Discord](https://discord.gg/qGWVtSa26K) Server",
            },
            {
                "name": "Requirements to Join the NHS:",
                "value": "- If you are 12 to 14 years of age, you must have 100 hours minimum.\n- If you are 15 years or older, you must have 50 hours minimum.\n- Less than 4 Points on your F10\n- Maximum of 3 bans in the past 2 weeks on your F10\n- Be familiar with the NHS rules and procedures, which can be found [here](https://nhs.vicestudios.net/)",
            },
            {
    ...
    message.channel.send("||                              https://discord.gg/qGWVtSa26K                             ||");
};
