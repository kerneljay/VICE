  ...
  methods: {
    ...
    keyDown(e) {
      if (e.which === 38 || e.which === 40) {
        if (this.message.startsWith('/') && this.suggestions.length > 0) {
          ...
          this.message = this.suggestions[this.selectedSuggestionIndex].name;
        }
      } else if (e.which == 33) {
    ...
    send(e) {
      if(this.message !== '') {
        ...
        if (this.selectedSuggestionIndex !== -1 && this.message.startsWith('/')) {
          messageToSend = this.suggestions[this.selectedSuggestionIndex].name;
        }
