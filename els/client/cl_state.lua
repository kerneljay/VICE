...
RegisterNetEvent("VICEELS:changeStage", function(netId, stage)
...
RegisterNetEvent("VICEELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("VICEELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("VICEELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("VICEELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("VICEELS:indicatorChange", function(netId, indicator, enabled)
